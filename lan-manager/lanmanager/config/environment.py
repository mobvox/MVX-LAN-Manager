...
import lanmanager.lib.app_globals as app_globals
...
def load_environment(global_conf, app_conf):
    ...
    config.init_app(global_conf, app_conf, package='lanmanager', paths=paths)

    config['routes.map'] = make_map(config)
    config['pylons.app_globals'] = app_globals.Globals(config)
    config['pylons.h'] = lanmanager.lib.helpers
